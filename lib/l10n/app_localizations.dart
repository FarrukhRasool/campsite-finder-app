...
abstract class AppLocalizations {
  ...
  /// No description provided for @filterCampsitesTitle.
  ///
  ...
  /// No description provided for @closeToWaterTitle.
  ///
  /// In en, this message translates to:
  /// **'Close to Water'**
  String get closeToWaterTitle;

  /// No description provided for @campFireAllowedTitle.
  ///
  /// In en, this message translates to:
  /// **'Camp Fire Allowed'**
  String get campFireAllowedTitle;

  /// No description provided for @speakingLanguageTitle.
  ///
  /// In en, this message translates to:
  /// **'Speaking Language'**
  ...
  /// No description provided for @notNearWaterTitle.
  ///
  /// In en, this message translates to:
  /// **'Not Near Water'**
  String get notNearWaterTitle;

  /// No description provided for @noCampfireTitle.
  ///
  /// In en, this message translates to:
  /// **'No Campfire'**
